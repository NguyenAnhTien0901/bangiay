...
<head>
     <meta charset="UTF-8">
     <link rel="shortcut icon" type="image/png" href="images/hutech logo.png />
     <meta name="viewport" content="width=device-width, initial-scale=1.0">
     <meta name="author" content="Nguyen Anh Tien ">
     <meta content="Nguyen Anh Tien " name="Developer">
     <meta name="keywords"
     ...
     <title>
          ...
          switch ($stamp) {
               case 'chitietsanpham':
                    echo "HutechShoe: Chi tiết sản phẩm";
                    break;
               case 'giohang':
                    echo "HutechShoe: Giỏ hàng";
                    break;
               case 'search':
                    echo "HutechShoe: Tìm kiếm sản phẩm";
                    break;
               case 'lienhe':
                    echo "HutechShoe: Liên hệ";
                    break;
               case 'gioithieu':
                    echo "HutechShoe: Tuyển dụng";
                    break;
               case 'cuahang':
                    echo "HutechShoe: Cửa hàng";
                    break;
               case 'kiemtradonhang':
                    echo "HutechShoe: Kiểm tra đơn hàng";
                    break;
               case 'thanhtoan':
                    echo "HutechShoe: Thanh toán";
                    break;
               case 'login':
                    echo "HutechShoe: Đăng nhập";
                    break;
               case 'logup':
                    echo "HutechShoe: Đăng xuất";
                    break;
               default:
                    echo "HutechShoe: Trang chủ";
                    break;
          }
