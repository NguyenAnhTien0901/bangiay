<header class="umine-top">
    ...
    <div class="map">
        <div class="show-map">
            ...
            <div class="img-map">
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3022.066064282507!2d106.71227745236403!3d10.800991711895199!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x317528a459cb43ab%3A0x6c3d29d370b52a7e!2zSFVURUNIIC0gxJDhuqFpIGjhu41jIEPDtG5nIG5naOG7hyBUUC5IQ00gKFNhaSBHb24gQ2FtcHVzKQ!5e0!3m2!1svi!2s!4v1712992147183!5m2!1svi!2s"
        ...
        <div class=" flex-header v-center">
            ...
            <a href="index.php" class="header-search__logo-section">
                    <div class="header-search__logo-wrapper">
                        <img src="images/hutech logo.png" alt="logo">
                    </div>
            </a>

            <form role="search" autocomplete="off" action="index.php?action=search" method="POST" class="umine-searchbar">
                <input class="umine-searchbar-input__input" maxlength="128" placeholder="Tìm kiếm hơn 200+ sản phẩm..." autocomplete="off" aria-expanded="false" role="combobox" value="" name="keyword">
