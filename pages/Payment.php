    ...
    <form action="pages/xulythanhtoan.php" method="POST" class="page-payment">
        <div class="column-left-pay">
            ...
            <div class="center-img">
                <img src="images/hutech logo.png" alt="" />
            </div>
            </a>
            <div class="in4-payment">
                <div class="receiving-in4">
                    ...
                    <div class="form-in4-pay">
                        <input type="email" name="email" placeholder="Email" class="inp-pay"
                            required value="<?php echo isset($cot['email']) ? $cot['email'] : '' ?>"/><br />
                        ...
                        <div class="tel-pay">
                            <input type="tel" name="sodth" placeholder="Số điện thoại" class="inp-pay inp-tel"
                                required value="<?php echo isset($phone) ? $phone : '' ?>" />
                            <div class="con">
                                <select>
                    ...
                    <div class="payment-methods">
                        ...
                        <div class=" inp-pay">
                            ...
                            <div class="atm-banking-in4" style="text-align: center; ">
                                ...
                                <p><b>Tên TK : </b> NGUYEN ANH TIEN</p>    
                            </div>
                        </div>
                    </div>
                </div>
